...
class ProbeHashMap(HashMapBase):
    ...
    """
    _AVAIL_ = object()  # oggetto generico: locazioni di segni sentinelle relative a cancellazioni precedenti
    ...
    def _find_slot(self, j, k):
        ...
        - se è stata trovata una corrispondenza, 'successo' sara True e 'indice' indica la sua posizione;
        - se non è stata trovata una corrispondenza, 'successo' sara False e 'indice' indica il primo slot disponibile.
        """
        firstAvail = None
        while True:
