...
class HeapPriorityQueue(PriorityQueueBase):
    ...
    def _downheap(self, j):
        if self._has_left(j):
            ...
            if self._data[small_child] < self._data[j]:
                ...
                self._downheap(small_child)     # prosegue nella posizione dello small_child
    ...
    def add(self, key, value):
        ...
        self._upheap(len(self._data) - 1)   # "fa risalire" la posizione appena aggiunta
    ...
    def remove_min(self):
        ...
        self._downheap(0)                       # fix della radice
        return (item._key, item._value)
